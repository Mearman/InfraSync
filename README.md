...
| **Tailscale** | Planned | `Device`, `DNSNameserver`, `DNSSearchPath`, `ACLPolicy`, `TailnetKey` | [tailscale/tailscale](https://registry.terraform.io/providers/tailscale/tailscale/latest/docs) | — | [Tailscale API](https://tailscale.com/kb/1101/api) |
